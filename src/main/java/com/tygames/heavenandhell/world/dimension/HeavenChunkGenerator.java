...
public class HeavenChunkGenerator extends NoiseChunkGenerator<HeavenGenSettings> {
        ...
        public HeavenChunkGenerator(IWorld worldIn, BiomeProvider provider, HeavenGenSettings settingsIn) {
